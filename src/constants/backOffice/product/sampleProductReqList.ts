...
export const sampleProductReqList: ProductReq[] = [
  {
    wineName: {
      korean: '그르기치 힐스 에스테이트 소비뇽 블랑',
      english: 'Grgich Hills Estate Sauvignon Blanc',
    },
    price: { value: 85000 },
    wineType: 'WHITE',
    tasteProfile: { sweetness: 1, acidity: 4, body: 3 },
    stock: 10,
    vintage: 2022,
    country: '미국',
    region: '캘리포니아 > 나파 밸리',
    grapeVariety: '소비뇽 블랑 (Sauvignon Blanc) 100%',
    winery: '그르기치 힐스 에스테이트 (Grgich Hills Estate)',
    alcoholContent: 14.1,
    tastingNote:
      '그린 애플, 레몬그라스, 부싯돌의 미네랄리티와 바삭하고 균형 잡힌 산미가 돋보이며, 열대 과일과 긴 피니시가 특징.',
    foodPairing: '구운 해산물, 치킨, 굴, 크림소스 파스타, 샐러드',
    description:
      '미국 와인을 세계에 알린 전설적 생산자의 나파 밸리 소비뇽 블랑. 유기농·바이오다이나믹 인증, 뛰어난 균형미와 산도.',
    imageUrl: null,
  },
  {
    wineName: {
      korean: '포스타 샤도네이',
      english: 'Four Star Chardonnay',
    },
    price: { value: 50000 },
    wineType: 'WHITE',
    tasteProfile: { sweetness: 2, acidity: 3, body: 3 },
    stock: 10,
    vintage: 2022,
    country: '미국',
    region: '캘리포니아',
    grapeVariety: '샤도네이 (Chardonnay) 100%',
    winery: '피오르 디 솔레 (Fior di Sole, LLC)',
    alcoholContent: 13.5,
    tastingNote:
      '사과, 배, 레몬, 버터스카치, 바닐라, 크리미한 토스트 풍미와 섬세한 미네랄 피니시. 오래 지속되는 살구와 패션후르츠의 여운.',
    foodPairing: '구운 닭고기, 크림 파스타, 해산물, 구운 야채',
    description:
      '캘리포니아의 따뜻한 햇살과 오크 숙성의 조화가 돋보이는, 부드럽고 풍부한 바디의 화이트 와인.',
    imageUrl: null,
  },
  {
    wineName: {
      korean: '보시오 모스카토 다스티 루카',
      english: "Bosio Moscato d'Asti Luca",
    },
    price: { value: 35000 },
    wineType: 'DESSERT',
    tasteProfile: { sweetness: 4, acidity: 2, body: 2 },
    stock: 10,
    vintage: 2023,
    country: '이탈리아',
    region: '피에몬테 > 아스티',
    grapeVariety: '모스카토 비앙코 (Moscato Bianco) 100%',
    winery: '보시오 (Bosio)',
    alcoholContent: 5.5,
    tastingNote:
      '풍부한 머스캣 향과 흰 꽃, 복숭아, 살구의 달콤한 아로마. 상쾌한 산미와 부드러운 기포, 가볍고 산뜻한 피니시.',
    foodPairing: '과일 타르트, 치즈 케이크, 마카롱, 신선한 과일',
    description:
      '달콤하고 향긋한 아스티 지역의 대표 스파클링 와인. 낮은 알코올과 상쾌한 단맛으로 디저트와 잘 어울림.',
    imageUrl: null,
  },
  {
    wineName: {
